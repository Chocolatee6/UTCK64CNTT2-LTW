...
namespace DataAccess.Controllers
{
    ...
    {
        private readonly TestTkwContext _context;

        public CtHoaDonsController(TestTkwContext context)
        {
            _context = context;
        }
        ...
        {
            var testTkwContext = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
            return View(await testTkwContext.ToListAsync());
        }
